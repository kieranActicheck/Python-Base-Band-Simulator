...
while True:
    ...
    try:
        ...
        api_url = "https://localhost:7265/api/data/receive"
        api_data = {
        ...
        try:
            api_response = requests.post(api_url, json=api_data, headers={"Content-Type": "application/json"}, verify=False)
            api_response.raise_for_status()
        except requests.exceptions.RequestException as e:
            logger.error("Error sending data to API: {}".format(e))
